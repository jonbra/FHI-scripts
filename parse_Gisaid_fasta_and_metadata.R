...
metadata_filtered <- metadata_Gisaid %>% 
  ...
  filter(str_detect(`Pango lineage`, "^BA.5.*") | str_detect(`Pango lineage`, "^BE.*") | str_detect(`Pango lineage`, "^BK.*") | str_detect(`Pango lineage`, "^BF.*") | str_detect(`Pango lineage`, "^BQ.*") | str_detect(`Pango lineage`, "^BV.*") | str_detect(`Pango lineage`, "^CF.*"))
